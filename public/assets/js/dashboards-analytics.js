...
(function () {
  ...
  // --------------------------------------------------------------------
  // Common configuration for all revenue charts
const createRevenueChart = (elementId, data) => {
  const chartConfig = {
    chart: {
      height: 130,
      type: 'area',
    ...
    colors: ['#9990f4'],  // Using a hex color for 'success' green
    fill: {
      type: 'gradient',
      gradient: {
        shade: 'light',
  ...
  if (chartElement) {
    const revenueChart = new ApexCharts(chartElement, chartConfig);
    revenueChart.render();
  }
};

// Initialize charts for each card by calling the function with respective IDs and data
createRevenueChart('revenueGeneratedAdmins', [300, 350, 330, 380, 340, 400, 380]);
createRevenueChart('revenueGeneratedUsers', [300, 350, 330, 380, 340, 400, 380]);
createRevenueChart('revenueGeneratedProducts', [300, 350, 330, 380, 340, 400, 380]);
createRevenueChart('revenueGeneratedBlogs', [300, 350, 330, 380, 340, 400, 380]);

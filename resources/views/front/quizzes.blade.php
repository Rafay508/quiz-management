...
@section('content')
    ...
    <div class="page-title light-background">
      <div class="container d-lg-flex justify-content-between align-items-center">
        <h1 class="mb-2 mb-lg-0">Quizzes</h1>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.html">Home</a></li>
            <li class="current">Quizzes</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
        ...
        <div class="row">
          <div class="col-lg-3">
            <div class="course-filters" data-aos="fade-right" data-aos-delay="100">
              <h4 class="filter-title">Filter Quizzes</h4>
            ...
            <div class="courses-grid" data-aos="fade-up" data-aos-delay="200">
              <div class="row">
                ...
                {{-- <div class="col-lg-6 col-md-6">
                  <div class="course-card">
                    <div class="course-image">
                      <img src="{{ asset('assets/front/img/education/courses-7.webp') }}" alt="Course" class="img-fluid">
                    ...
                    <div class="course-content">
                      ...
                      <div class="instructor-info">
                        <img src="{{ asset('assets/front/img/person/person-f-7.webp') }}" alt="Instructor" class="instructor-avatar">
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="course-card">
                    <div class="course-image">
                      <img src="{{ asset('assets/front/img/education/courses-12.webp') }}" alt="Course" class="img-fluid">
                    ...
                    <div class="course-content">
                      ...
                      <div class="instructor-info">
                        <img src="{{ asset('assets/front/img/person/person-m-8.webp') }}" alt="Instructor" class="instructor-avatar">
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="course-card">
                    <div class="course-image">
                      <img src="{{ asset('assets/front/img/education/courses-5.webp') }}" alt="Course" class="img-fluid">
                    ...
                    <div class="course-content">
                      ...
                      <div class="instructor-info">
                        <img src="{{ asset('assets/front/img/person/person-f-12.webp') }}" alt="Instructor" class="instructor-avatar">
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="course-card">
                    <div class="course-image">
                      <img src="{{ asset('assets/front/img/education/courses-9.webp') }}" alt="Course" class="img-fluid">
                    ...
                    <div class="course-content">
                      ...
                      <div class="instructor-info">
                        <img src="{{ asset('assets/front/img/person/person-m-5.webp') }}" alt="Instructor" class="instructor-avatar">
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="course-card">
                    <div class="course-image">
                      <img src="{{ asset('assets/front/img/education/courses-14.webp') }}" alt="Course" class="img-fluid">
                    ...
                    <div class="course-content">
                      ...
                      <div class="instructor-info">
                        <img src="{{ asset('assets/front/img/person/person-f-9.webp') }}" alt="Instructor" class="instructor-avatar">

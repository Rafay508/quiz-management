...
@section('content')
<div class="container-fliud my-4 mt-md-0 margin overflow-hidden" style="width:100vw">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 col-lg-12">
                        <div class="row py-4 px-1">
                            <h5 class='fw-bold px-2 pt-1 pt-md-0 border-start border-danger border-4 heading'>
                                {{ 'Upcoming Mobiles' }}
                            </h5>
